...
public class TeamUpdateRequest implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TeamUpdateRequest)) return false;
        final TeamUpdateRequest other = (TeamUpdateRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TeamUpdateRequest;
    }
    ...
    public String toString() {
        return "TeamUpdateRequest(id=" + this.getId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", expireTime=" + this.getExpireTime() + ", status=" + this.getStatus() + ", password=" + this.getPassword() + ")";
    }
}
